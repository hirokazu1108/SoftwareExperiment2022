...
void move_bullet(int num);    // ???????????�ç??????é?????????????????
void add_lifetime(int add_lifetimeID);  // ???????????�ç????????????????????é????????????????????????
void count_time(int count_timeID);      // ??????????????é??????????????????????????????????????????????????????é????????????????
void del_bullet(void);  // ???????????�ç????????é?????????????
...
void draw_bullet(int num){
    for(int i = 0; i < num; i++){
        ...
        if(can_special){
            glutSolidSphere(BULLET_RADIUS * 5, 16, 16);
        }
        glPopMatrix();
    }
}
